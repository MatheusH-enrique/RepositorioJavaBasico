...
git config --global user.name "MatheusH-enrique
git config --global user.email "matheus.santos1709@etec.sp.gov.br"

:: Adiciona o repositório remoto (só executa se já não estiver adicionado)
git remote get-url origin >nul 2>&1
if errorlevel 1 (
    git remote add origin "https://github.com/MatheusH-enrique/RepositorioJavaBasico.git"
)
